...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWQclkq4gmkJdXMuEGe2X3estqp9VvLPvyicW3gARLZSBiaUw5KLenaCxw/640?wx_fmt=png&amp;from=appmsg)
## 
...
@Retention @Target @Document @Inherited四种 是元注解即 “注解的注解”，还有Java1.8以后加进来的
...
getAnnotation(xxxAnnotation.class) 方法来获取指定类型的注解。


getAnnotations() 获取这个元素上所有的注解
...
- [Android Annotation](https://juejin.im/post/5a771b8b6fb9a0633c65e947)[扫盲笔记](https://juejin.im/post/5a771b8b6fb9a0633c65e947)
