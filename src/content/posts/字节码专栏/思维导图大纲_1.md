...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1699455320323-e91d9a36-0e93-4974-9520-0d46a8966e10.png)
...
- max_locals：**为当前方法分配的局部变量个数，包括调用方式时传递的参数。long 和 double 类型计数为 2，其他为 1。max_locals 的单位是 Slot,Slot 是 虚拟机为局部变量分配内存所使用的最小单位。局部变量表中的 Slot 可以重用，当代码执行超出一个局部变量的作用域时，这个局部变量 所占的 Slot 可以被其他局部变量所使用，Javac 编译器会根据变量的作用域来分配 Slot 给各个 变量使用，然后计算出 max_locals 的大小**。
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1699455353221-2ad129db-eb38-41de-976e-8ceb74e0f350.png)
...
### 查看字节码的工具
我们可以使用 [jclasslib](https://link.juejin.cn?target=https%3A%2F%2Fplugins.jetbrains.com%2Fplugin%2F9248-jclasslib-bytecode-viewer) 这个字节码工具去查看字节码，使用效果如下图所示，**代码编译后在菜单栏 ”View” 中选择 ”Show Bytecode With jclasslib”，可以很直观地看到当前字节码文件的类信息、常量池、方法区等信息**。
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1699455367611-6058642e-5b92-4483-8e1c-f1d8f6703cc8.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1699455387575-49cc6f7e-4e63-419c-90de-f34f00f627bc.png)
...
- 3、[深入拆解Java虚拟机 - 19 | Java字节码（基础篇）](https://link.juejin.cn?target=https%3A%2F%2Ftime.geekbang.org%2Fcolumn%2Farticle%2F14794)
- 4、[Android 工程师进阶 34 讲 - 第03讲：字节码层面分析 class 类文件结构](https://link.juejin.cn?target=https%3A%2F%2Fkaiwu.lagou.com%2Fcourse%2FcourseInfo.htm%3FcourseId%3D67%23%2Fdetail%2Fpc%3Fid%3D1857)
- 5、[极客时间之Android开发高手课 编译插桩的三种方法：AspectJ、ASM、ReDex](https://link.juejin.cn?target=https%3A%2F%2Ftime.geekbang.org%2Fcolumn%2Farticle%2F71982)
- 6、[Java 字节码 (Bytecode) 与 ASM 简单说明](https://link.juejin.cn?target=http%3A%2F%2Fblog.hakugyokurou.net%2F%3Fp%3D409)
- 7、[字节码操纵技术探秘](https://link.juejin.cn?target=https%3A%2F%2Fwww.infoq.cn%2Farticle%2FLiving-Matrix-Bytecode-Manipulation)
- 8、[字节码增强技术探索](https://link.juejin.cn?target=https%3A%2F%2Ftech.meituan.com%2F2019%2F09%2F05%2Fjava-bytecode-enhancement.html)
- 9、[The Java® Virtual Machine Specification](https://link.juejin.cn?target=https%3A%2F%2Fdocs.oracle.com%2Fjavase%2Fspecs%2Fjvms%2Fse11%2Fhtml%2Findex.html)
