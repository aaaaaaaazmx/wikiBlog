---
title: "【Android 修炼手册】Gradle 篇 -- Gradle 源码分析"
published: 2024-04-19
description: "【Android 修炼手册】Gradle 篇 -- Gradle 源码分析"
tags: ["Gradle","构建工具"]
category: "gradle"
draft: false
slug: "gradle-004"
...
1. clone [EasyGradle](https://github.com/5A59/android-training/tree/master/gradle/EasyGradle) 项目
...
### 一、Gradle 的启动
#### 1.1 整体实现图
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWYl7YibuTiayu4NAbw33H2t6gm9OsicGC2d3iaTfO17G8mKDUiabqiceUfGQw/640?wx_fmt=png&amp;from=appmsg)
#### 1.2 具体分析
...
### 二、loadSettings
#### 2.1 整体实现图
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWvqv7dJwEoIwZ6ib4IHagac2st3I7AGluXuia1OsqcYXibdHJ9I5G54HSw/640?wx_fmt=png&amp;from=appmsg)
#### 2.2 具体分析
...
### 三、configureBuild
#### 3.1 整体实现图
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWXsRa7O4iaL7IR7Kz1CrKib6g8aALjxJjVMuY5E4yhBEVV3yGarfiblOlA/640?wx_fmt=png&amp;from=appmsg)
#### 3.2 具体分析
...
#### 4.1 整体实现图
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWibGjWibXHANtFkkjE9b65LSvA5vjdTtECAfkyJa0KbnQDXuW1v32Abicg/640?wx_fmt=png&amp;from=appmsg)
#### 4.2 具体分析
这一步是构建 task 依赖图
```
// DefaultGradleLauncher
...
### 五、runTasks
#### 5.1 整体实现图
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWiaZS9kkvRNDFVJL0SCb0NYEFhl4YeKCV9DC8IiaXCPJG8ssa43SqgLUA/640?wx_fmt=png&amp;from=appmsg)
#### 5.2 具体分析
...
### 六、finishBuild
#### 6.1 整体实现图
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWEhYpuo6ABiaJznldiaSRZPYbN9xp4Eu4goDNefarY3wgMZNLsBP4hltA/640?wx_fmt=png&amp;from=appmsg)
#### 6.2 具体分析
```
...
目录下的 class 如下：
![image.png](https://cdn.nlark.com/yuque/0/2020/png/215777/1580569376749-d1ff8599-187d-440a-94f2-e623aff48e23.png)
3. 具体编译方法是通过 RemappingScriptSource.getResource().getText() 获取到脚本内容，然后通过 GroovyClassLoader.parseClass 编译的。
我们以 [app/build.gradle](https://github.com/5A59/android-training/blob/master/gradle/EasyGradle/app/build.gradle) 为例，看一下最终生成的脚本是什么样子的。
build.gradle 脚本内容
```
...
### 九、总结
整体结构图
![](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWQsrWOmmXuHg2PktJTXEm5ibr7tCRibb1kF1SQCSicZ2sU6ict8QAEDX9ibw/640?wx_fmt=png&amp;from=appmsg)
...
3. 脚本编译流程 获取脚本内容 -> 编译成 class 文件，继承自 ProjectScript -> 执行 ProjectScript.run 方法
