...
description: "Java 泛型了解么？什么是类型擦除？介绍一下常用的通配符？"
tags: ["Java","基础"]
category: "java基础"
draft: false
slug: "java-basic-016"
...
![](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLVcyUqrgdSOGULtk7dZIguJ7Pp7Pz8brheM9h6ssgY2M4ySK7PCK4qg0O7fm4UPhzzSyLiacNtUogw/640?wx_fmt=png&amp;from=appmsg)
泛型类、泛型接口、泛型方法
**1.泛型类**：
```java
