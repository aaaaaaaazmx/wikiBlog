---
title: "View机制设计与实现：测量流程"
published: 2022-02-15
description: "View机制设计与实现：测量流程"
tags: ["自定义View","Android","UI"]
category: "自定义View专栏"
draft: false
slug: "custom-view-017"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWziarL1xNA6nS8ZPvXHG1Nye98kuB02P4UiaTPV0lMWFupREIYa35ykjQ/640?wx_fmt=png&amp;from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWVTnibF2hDuEjPvegQhhBdltJ99VhrPqJCIpGhtD6g5utmI04SFUuO7A/640?wx_fmt=png&amp;from=appmsg)

而当需要获得`Mode`的时候只需要用`measureSpec`与`MODE_TASK`相与即可，如下图：

![](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWH7mTDoQbAgiabicmeRukuvc4qPP9ibdUOSSU2bHqALia9SmOOeiaaIoy7jw/640?wx_fmt=png&amp;from=appmsg)

同理，想获得`size`的话只需要只需要`measureSpec`与`~MODE_TASK`相与即可，如下图：

![](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVW4esBVOmyll9wR6sG8zWLtHTsW8GvbLQib5ficreOJFmuMP4mVUZpKQOA/640?wx_fmt=png&amp;from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVW01EHSibaxmk2rRJ0iaQ1166hL5dlWjhCu4dRQkjDv46Vvm9xTmCgJdag/640?wx_fmt=png&amp;from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWgzQhAD3K8e1ov0uOZvq9gwpCFHia2eFdiaPFfFFVQGQ1njHaAGiaJGTvA/640?wx_fmt=png&amp;from=appmsg)
