---
title: "View机制的设计与实现：事件拦截"
published: 2023-09-10
description: "View机制的设计与实现：事件拦截"
tags: ["自定义View","Android","UI"]
category: "自定义View专栏"
draft: false
slug: "custom-view-015"
---
...
本文整体结构如下图：
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711963399923-5095da88-5857-484e-a971-95d8e6b0d073.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711963418975-fe2389ce-91c3-4cc5-9be5-b4904c780407.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711963433164-1fc5d230-8622-48d7-bdc5-43f374dff77f.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711963445970-25c49344-3347-4e66-b6a6-cf64eb70e575.png)

每个`View`节点都持有事件的下一级消费者，当同一事件序列后续的触摸事件抵达时，不再需要进行消耗性能的`DFS`算法，而是直接交给下一级的子`View`，子`View`则直接交给下下一级的子`View`，直到事件到达真正的消费者：
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711963455754-adb1b2ce-6431-497d-b5fa-6f5e10e350c4.png)
