...
category: "性能优化"
draft: false
slug: "performance-011"
---

[https://juejin.cn/post/6844904047355363341](https://juejin.cn/post/6844904047355363341)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756636868-f981055e-dbc5-4e35-a984-6df5909466fc.png)
...
## 2、Android 图形系统的整体架构
Android官方的架构图如下：
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756650255-ebd0acea-cefc-4c73-9ca9-2bf1d6e029ad.png)
...
在了解完Android图形系统的整体架构之后，我们还需要了解下Android系统的显示原理，关于这块内容可以参考我之前写的[Android性能优化之绘制优化](https://link.juejin.cn?target=https%3A%2F%2Fjsonchao.github.io%2F2019%2F07%2F28%2FAndroid%25E6%2580%25A7%25E8%2583%25BD%25E4%25BC%2598%25E5%258C%2596%25E4%25B9%258B%25E7%25BB%2598%25E5%2588%25B6%25E4%25BC%2598%25E5%258C%2596%2F)的Android系统显示原理一节。
## 3、RenderThread
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756664355-8bef8dd5-ab7a-4a4e-af68-0310f3d6bf9c.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756679750-70d1289e-4936-47cb-b896-5a8526189836.png)
...
- 1、由于OLED是**有机材料**，导致其寿命是不如LCD的 有机材料的。并且，由于OLED单独点亮的功能，会使每个像素点工作的时间不一样，这样，在屏幕老化时就会导致色彩显示不均匀，即产生**烧屏**现象。
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756704671-71f03444-3282-476d-b188-26a2df983180.png)
比如以480x320为基准分辨率：
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756720405-54b6d3e5-a8f0-4e6a-8370-b8dbc4088ebf.png)
...
[项目地址](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FhongyangAndroid%2FAndroidAutoLayout)
基本使用步骤如下：
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756755575-8163336e-8174-404c-b349-05f066a7838f.png)
假如加入我们的设计稿的像素宽度是375，那么其对应的values-sw360dp和values-sw400dp宽度如下所示：
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756764601-9e6ac618-b3a5-4abf-a99a-2f862e148738.png)
...
插件地址为[自动生成values-sw的项目代码](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fladingwu%2Fdimens_sw)。生成需要的values-swdp文件夹的步骤如下：
...
这里推荐一下JessYanCoding的[AndroidAutoSize](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FJessYanCoding%2FAndroidAutoSize)项目，用法如下：
...
# 三、优化工具
## 1、Systrace
早在[深入探索Android启动速度优化](https://link.juejin.cn?target=https%3A%2F%2Fjsonchao.github.io%2F2019%2F11%2F10%2F%25E6%25B7%25B1%25E5%2585%25A5%25E6%258E%25A2%25E7%25B4%25A2Android%25E5%2590%25AF%25E5%258A%25A8%25E9%2580%259F%25E5%25BA%25A6%25E4%25BC%2598%25E5%258C%2596%2F)一文中我们就了解过Systrace的使用、原理及它作为启动速度分析的用法。而它其实主要是用来分析绘制性能方面的问题。下面我就详细介绍下Systrace作为绘制优化工具有哪些必须关注的点。
### 1）、关注Frames
首先，先在左边栏选中我们当前的应用进程，在应用进程一栏下面有一栏Frames，我们可以看到**有绿、黄、红三种不同的小圆圈**，如下图所示：
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWxTIb0ibFPHKW3P13iauib9OcFUv8vXLYhuzsklv7Iia0hN9aJYfOkRga3Q/640?wx_fmt=png&amp;from=appmsg)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756816956-d7586be2-0ebc-4d30-a826-cb0aa09d238f.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756824704-18cf3d01-58b0-4261-a8b9-176da3f517e6.png)
...
```
下面为操作之后打开的[Awesome-WanAndroid](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FJsonChao%2FAwesome-WanAndroid)首页图，如下所示：
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756837504-24e90e0b-d836-4df5-b962-5ad84ee159ca.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756848755-675f31b4-3501-4972-8266-a9f9f28b780f.png)
## 3、Choreographer
...
```
这里我以[Awesome-WanAndroid](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FJsonChao%2FAwesome-WanAndroid)项目为例，输出其对应的gfxinfo信息如下所示：
```
css
...
![image.png](https://cdn.nlark.com/yuque/0/2023/png/215777/1698756886409-7d53808e-6859-4c7b-ab55-25fa9d6b0d6a.png)
...
[深入探索Android布局优化（中）](https://juejin.im/post/6870445845834104846)
