---
title: "图解 Android 系列（三）探索 SystemServer 进程创建过程"
published: 2025-04-26
description: "图解 Android 系列（三）探索 SystemServer 进程创建过程"
tags: ["Android","Framework","专栏"]
category: "framework专栏"
draft: false
slug: "framework-col-014"
---
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711986938935-cf761f38-ea0d-48b6-8940-f1ad31267e65.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711986952491-4b731a35-c9ad-4202-bd2c-38a9ce1249ac.png)
## zygoteInit()
```java
//frameworks/base/core/java/com/android/internal/os/ZygoteInit.java
...
```
ProcessState::self() 是单例模式，主要工作是调用 open() 打开 /dev/binder驱动设备，再利用 mmap() 映射内核的地址空间，将 Binder 驱动的 fd 赋值 ProcessState 对象中的变量 mDriverFD，用于交互操作。startThreadPool() 是创建一个新的 binder 线程，不断进行 talkWithDriver()，这里先有个印象，关于 Binder 驱动相关细节我们在后面章节再讨论。
#### applicationInit()
```java
//frameworks/base/core/java/com/android/internal/os/RuntimeInit.java
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVW5SOl6yuwo7XMXaCiao8Kibz6UwO151RtceqPxgjNleTRChIeeGTsjvuA/640?wx_fmt=png&amp;from=appmsg)
