---
title: "图解 Android 系列（四）原来 SystemServer 启动时干了这么多"
published: 2025-08-06
description: "图解 Android 系列（四）原来 SystemServer 启动时干了这么多"
tags: ["Android","Framework","专栏"]
category: "framework专栏"
draft: false
slug: "framework-col-015"
---
...
## 服务启动阶段
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLWkpfu3WMQgPVqETicpibhdVWvic22lxAcJQGpkP6QShtOJzXPavMkicFLvhd196yumdavR6tf96c6siaA/640?wx_fmt=png&amp;from=appmsg)
```java
...
### Phase 1000
在经过一系列流程，再调用 AMS.finishBooting() 时，则进入 Phase 1000阶段。
