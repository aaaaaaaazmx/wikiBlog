---
title: "Android - Activity 与 Window 与 View 之间的关系"
published: 2022-11-21
description: "Android - Activity 与 Window 与 View 之间的关系"
tags: ["Android","Framework","专栏"]
category: "framework专栏"
draft: false
slug: "framework-col-002"
---
...
如不了解 Activity 的启动过程请参阅：[Activity 启动过程](https://github.com/jeanboydev/Android-ReadTheFuckingSourceCode/blob/master/article/android/framework/Android-Activity%E5%90%AF%E5%8A%A8%E8%BF%87%E7%A8%8B.md)
本文主要对于以下问题进行分析：

- Window 是什么？
- Activity 与 PhoneWindow 与 DecorView 之间什么关系？
## onCreate() - Window 创建过程
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLUFJphXRH1q0vbjlrt8VXre0oYSfeN4hmxQibribgMEt0HTWFNlfbBTAmNu7fZQLmfiafygibxj3hV7Zg/640?wx_fmt=png&amp;from=appmsg)
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLUFJphXRH1q0vbjlrt8VXreflkVnt7kMy3EcDMxCic2fuib62Voicn9YjUC7JibP1DThtjH7LTFfFAbTA/640?wx_fmt=png&amp;from=appmsg)
...
```
通过 binder 调用进入 system_server 进程。 Session：
```java
...
```
创建 Surface 的过程详见：[SurfaceFlinger 图形系统](https://github.com/jeanboydev/Android-ReadTheFuckingSourceCode/blob/master/article/android/framework/Android-SurfaceFlinger%E5%9B%BE%E5%BD%A2%E7%B3%BB%E7%BB%9F.md)
Activity 中 Window 创建过程：
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLUFJphXRH1q0vbjlrt8VXreXlGR2RuUJBO5mL2mW1TTyiaOvjboUw36mW76gcwu4uG3aFhDXGamHwQ/640?wx_fmt=png&amp;from=appmsg)
## 总结
