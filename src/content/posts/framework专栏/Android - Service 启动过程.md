---
title: "Android - Service 启动过程"
published: 2025-04-20
description: "Android - Service 启动过程"
tags: ["Android","Framework","专栏"]
category: "framework专栏"
draft: false
slug: "framework-col-007"
---
...
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLUFJphXRH1q0vbjlrt8VXreBJEpPYXV1KcRwzqymiaGKMVRuLqB5h3icsD3eCC1U5Chs8pE7gYlQKsg/640?wx_fmt=png&amp;from=appmsg)
## startService
...
使用这种 start 方式启动的 Service 的生命周期如下： onCreate() -> onStartCommand()（onStart()方法已过时） -> onDestory()
...
使用这种 start 方式启动的 Service 的生命周期如下： onCreate() -> onBind() -> onUnbind() -> onDestory()
