...
description: "Android - Handler 消息机制"
tags: ["Android","Framework","专栏"]
category: "framework专栏"
draft: false
slug: "framework-col-005"
---
...
## Handler机制
Handler工作流程
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLUFJphXRH1q0vbjlrt8VXreEBzzjERcI7pNRoW8ibsL4vic54zShjdyXI6aOeNw0Uia8YX437mHpBljw/640?wx_fmt=png&amp;from=appmsg)
Looper
...
#### 1. Looper 工作原理
先看一下 Looper 工作流程
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLUFJphXRH1q0vbjlrt8VXre8oPUhzia5T2dxPffkyCsnQfFPgYY7VHTthnSPRmltQqaickKt0XMzUVw/640?wx_fmt=png&amp;from=appmsg)
...
MessageQueue 工作流程
![image.png](https://mmbiz.qpic.cn/mmbiz_png/LrDMVD5bqLUFJphXRH1q0vbjlrt8VXrewP7tqgn6swnvos78XvFKR8DOKTmtlGfmheJoCszw5TP3vtmzIRqdzQ/640?wx_fmt=png&amp;from=appmsg)
MessageQueue的构造方法。
```java
