---
title: "define MAKE_STR(x) __STRING(x)"
published: 2020-08-29
description: "define MAKE_STR(x) __STRING(x)"
tags: ["Android","Framework","专栏"]
category: "framework专栏"
draft: false
slug: "framework-col-010"
---
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711986825847-be6b148b-b7c7-44bb-bf14-08ecff41868a.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711986841540-136c9ef7-f939-4c69-b592-fe6feea01186.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711986850506-b64f7f4e-4ca7-41c9-8b94-ec413d24e2cc.png)
在 init.rc 文件头部有这么一句：
```c
...
```
这里 startSystemServer() 方法会抛出一个 Zygote.MethodAndArgsCaller异常，然后调用到 caller.run()，这里会在 SystemServer 章节继续分析。
### preload()
```java
//frameworks/base/core/java/com/android/internal/os/ZygoteInit.java
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711986870138-19a4d31c-2c77-4552-a24c-e22faae9ca54.png)
### startSystemServer()
```java
//frameworks/base/core/java/com/android/internal/os/ZygoteInit.java
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/215777/1711986920128-51705382-c27f-4a47-a225-91055f7ef6ab.png)
